"""
Django settings for statsbomb-backend project.
...
MIDDLEWARE = [
    ...
    # 'whitnoise.middleware.WhiteNoiseMiddleware', // for production only
...
ROOT_URLCONF = 'statsbomb-backend.urls'
...
WSGI_APPLICATION = 'statsbomb-backend.wsgi.application'
...
# django_heroku.settings(locals()) // uncomment for heroku production
